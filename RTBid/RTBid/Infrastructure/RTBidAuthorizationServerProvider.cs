...
{
    public class RTBidAuthorizationServerProvider : OAuthAuthorizationServerProvider
    {
        ...
        public RTBidAuthorizationServerProvider(Func<IAuthorizationRepository> authRepositoryFactory)
        {
